...
//Marine roles
#define ROLES_OFFICERS list(JOB_CO, JOB_XO, JOB_SO, JOB_AUXILIARY_OFFICER, JOB_INTEL, JOB_PILOT, JOB_DROPSHIP_CREW_CHIEF, JOB_SEA, JOB_CORPORATE_LIAISON, JOB_COMBAT_REPORTER, JOB_SYNTH, JOB_CHIEF_POLICE, JOB_WARDEN)
...
var/global/list/ROLES_POLICE = list(JOB_CHIEF_POLICE, JOB_WARDEN, JOB_POLICE, JOB_PROVOST_MARSHAL)
...
var/global/list/ROLES_AI_AMONGUS = list(JOB_PROVOST_MARSHAL, JOB_CO, JOB_CMO, JOB_CHIEF_POLICE)
var/global/list/ROLES_AI_MASTERCHEF = list(JOB_CO, JOB_MESS_SERGEANT, JOB_XO, JOB_SO, JOB_CORPORATE_LIAISON, JOB_COMBAT_REPORTER)
