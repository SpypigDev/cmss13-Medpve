...
GLOBAL_LIST_INIT(ROLES_POLICE, list(JOB_CHIEF_POLICE, JOB_WARDEN, JOB_POLICE, JOB_PROVOST_MARSHAL))
...
GLOBAL_LIST_INIT(ROLES_AI_AMONGUS, = list(JOB_PROVOST_MARSHAL, JOB_CO, JOB_CMO, JOB_CHIEF_POLICE))
GLOBAL_LIST_INIT(ROLES_AI_MASTERCHEF, = list(JOB_CO, JOB_MESS_SERGEANT, JOB_XO, JOB_SO, JOB_CORPORATE_LIAISON, JOB_COMBAT_REPORTER))
