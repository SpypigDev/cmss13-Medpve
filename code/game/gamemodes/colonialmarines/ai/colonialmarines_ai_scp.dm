...
/datum/game_mode/colonialmarines/ai/scp/proc/handle_xeno_spawn(datum/source, mob/living/carbon/xenomorph/spawning_xeno, ai_hard_off = FALSE)
	SIGNAL_HANDLER
	if(ai_hard_off)
		return
...
GLOBAL_LIST_INIT(platoon_to_jobs, list(
		/datum/squad/marine/forecon/containment = list(/datum/job/command/bridge/ai = JOB_SO,\
...
GLOBAL_LIST_INIT(platoon_to_role_list, list(/datum/squad/marine/alpha = ROLES_AI,\
												...
												/datum/squad/marine/forecon/containment = ROLES_AI_FORECON,\
...
/datum/game_mode/colonialmarines/ai/scp/proc/spawn_personal_weapon()
